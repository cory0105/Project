...
public class CalendarExercisePlanService {
    ...
    public List<CalendarExercisePlan> findCalendarExercisePlanByCalendars(List<Calendar> calendar){
        return calendarExercisePlanRepository.findAllByCalendarIn(calendar);
    }
}
